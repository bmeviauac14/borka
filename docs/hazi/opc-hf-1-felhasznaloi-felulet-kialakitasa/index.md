...
A feladatok gyakorlati hátteréül a kapcsolód előadások és a [A felhasználói felület kialakítása](../../gyakorlat/felhasznaloi-felulet/index.md) laborgyakorlat szolgál.
...
- Az alapfolyamat megegyezik a korábbiakkal. Az AHK segítségével hozz létre magadnak egy repository-t. A meghívó URL-t Moodle-ben találod (a tárgy nyitóoldalán az "*AHK hivatkozások a házi feladatokhoz*" hivatkozásra kattintva megjelenő oldalon látható). Fontos, hogy a megfelelő, ezen házi feladathoz tartozó meghívó URL-t használd (minden házi feladathoz más URL tartozik). Klónozd le az így elkészült repository-t. Ez tartalmazni fogja a megoldás elvárt szerkezetét. A feladatok elkészítése után commit-old és push-old a megoldásod.
